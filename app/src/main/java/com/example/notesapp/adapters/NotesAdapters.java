...
public class NotesAdapters  extends RecyclerView.Adapter<NotesAdapters.NotesViewHolder>{
    ...
    static class NotesViewHolder extends RecyclerView.ViewHolder{
        ...
        RoundedImageView imageNote;
         NotesViewHolder(@NonNull View itemView) {
            super(itemView);
            textTitle=(TextView)itemView.findViewById(R.id.item_noteTitle);
            textSubtitle=(TextView)itemView.findViewById(R.id.item_noteSubtitle);
            textDateTime=(TextView)itemView.findViewById(R.id.item_dateTime);
